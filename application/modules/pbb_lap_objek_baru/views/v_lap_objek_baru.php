			...
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST">
						<div class="col-md-10 col-sm-10 col-xs-12">
							<div class="form-group">
								<label class="control-label col-md-4 col-sm-4 col-xs-12" for="PeriodeAwal">
									Periode Awal Pendataan : <span class="required">*</span>
								</label>
						...
						<div class="col-md-10 col-sm-10 col-xs-12">
							<div class="form-group">
								<label class="control-label col-md-4 col-sm-4 col-xs-12" for="PeriodeAkhir">
									Periode Akhir Pendataan : <span class="required">*</span>
								</label>
								<div class="col-md-8 col-sm-8 col-xs-12">
						...
						<div class="col-md-10 col-sm-10 col-xs-12">
							<div class="form-group">
								<label class="control-label col-md-4 col-sm-4 col-xs-12" for="KdJnsPelayanan">
									Jenis Pelayanan : <span class="required">*</span>
								</label>
								<div class="col-md-8 col-sm-8 col-xs-12">
									<select id="KdJnsPelayanan" name="KdJnsPelayanan" required="required" class="form-control">
										<option selected value=''>PILIH JENIS PELAYANAN</option>
										<option value='01'>PENDAFTARAN DATA BARU</option>
										<option value='02'>MUTASI OBJEK/SUBJEK</option>
										<option value='03'>PEMBETULAN SPPT/SKP/STP</option>
										<option value='04'>PEMBATALAN SPPT/SKP</option>
										<option value='05'>SALINAN SPPT/SKP</option>
										<option value='06'>KEBERATAN PENUNJUKAN WAJIB PAJAK</option>
										<option value='07'>KEBERATAN ATAS PAJAK TERHUTANG</option>
										<option value='08'>PENGURANGAN ATAS BESARNYA PAJAK TERHUTANG</option>
										<option value='09'>RESTITUSI DAN KOMPENSASI</option>
										<option value='10'>PENGURANGAN DENDA ADMINISTRASI</option>
										<option value='11'>PENENTUAN KEMBALI TANGGAL JATUH TEMPO</option>
										<option value='12'>PENUNDAAN TANGGAL JATUH TEMPO SPOP</option>
										<option value='13'>PEMBERIAN INFORMASI PBB</option>
										<option value='14'>PEMBETULAN SK KEBERATAN</option>
									</select>
								</div>
							</div>
						</div>
