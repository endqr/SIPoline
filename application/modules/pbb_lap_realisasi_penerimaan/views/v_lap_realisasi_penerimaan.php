        <div id="page-wrapper">
			...
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action = "<?php echo site_url().'/pbb_lap_realisasi_penerimaan/GenerateLaporan';?>" method="POST">
