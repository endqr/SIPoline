...
*
*/
class Pbb_lap_realisasi_penerimaan extends CI_Controller{
	...
	function index() {
	    ...
	    $data['main_content'] = 'v_lap_realisasi_penerimaan'; 
	...
	function GenerateLaporan() {
		...
		$x = 0;
 		$xUrl = 'http://172.20.31.1/sismiop/web_service_endqr/getRealisasiPenerimaanPBB?PeriodeAwal='.$PeriodeAwal.
		...
		$data['JudulLaporan'] = "Laporan Realisasi Penerimaan PBB Per Bank<br>Periode : ".$PeriodeAwal[2]."-".$PeriodeAwal[1]."-".$PeriodeAwal[0]." s/d ".$PeriodeAkhir[2]."-".$PeriodeAkhir[1]."-".$PeriodeAkhir[0];
	    $this->load->view('template', $data); 
    }
}